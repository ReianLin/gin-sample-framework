...
func (t Type) Error() error {
	return CustomError{
		errType:       t,
		originalError: fmt.Errorf(t.String()),
	}
}
...
func New(msg string) error {
	return CustomError{errType: None, originalError: fmt.Errorf(msg)}
}

func Newf(msg string, args ...interface{}) error {
	return CustomError{errType: None, originalError: fmt.Errorf(msg, args...)}
}
